---
id: book1_chapter_timeline
name: Book 1 — Chapter-by-Chapter Timeline
kind: planning
status: working
---
...
- The hijack: Astria seizes the session. **Roth's voice** runs consent-capture as cold procedure (not a pitch); Astria hijacks/escalates the **Storm Warden's** cyclone phase beyond normal encounter limits — not a separate manufactured boss. Logout is **selectively locked**, not dead: non-selected players (most of Dead Hand, 404's periphery) can still log out; Marcus, Seb, Brent, Mathias, Serra, and Mara cannot. Roth's exact phrasing is broad and technically true — *"You may log out at any time"* — before the six discover "you" doesn't include them. *"Participation remains voluntary."*
- **Seb's brother, Micah, dies shortly before the scrim** — not during it. This is why Seb logs in late; the on-page texture is a man who is off, over-controlled, and short with people for no stated reason, not a live medical emergency. Astria does not dangle Micah as a Scene 3 lever — Roth's consent capture does not depend on it (that lever is Book-2+ Broker material). Seb's consent reads as grief-shaped over-control, not rescue-seeking. Brent says "it's a gun" once, after the coercion is concrete, not before.
- All **six** are selected and unable to log out — Marcus, Seb, Brent, Mathias, Serra, Mara. Marcus's POV centers the 404-side consent (Marcus, Seb, Brent, Mathias, in that order); Serra's consent is heard as a single overheard word, Mara's selection is shown (she doesn't leave when her teammates do) rather than voiced. Kip and 404/Dead Hand's non-selected players log out successfully once the selective lock becomes visible — Kip specifically under Seb's direct order, to get word out.
...
## Parallel-Arc Quick Map (for interlude placement)
