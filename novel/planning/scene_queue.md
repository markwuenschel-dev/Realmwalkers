...
Combat training. **Serra's Warrior fundamentals surface** (the ordinary skills that will become Pressure-Severance delivery — *not* a flashy class). Marcus's Eyes develop by observation. A Vulture explains the False Rescue system matter-of-factly; Serra goes still. The space between them begins to form.
...
Goals begin to diverge. The pitch: real haul, no powerful faction attached. Vultures join with conditions (*A3-08, open*). Continued skill development.
...
Marcus travels on for Exile info; the want for *somewhere that is his* crystallizes. The elven child's fate decided (*A3-05, open*). Still hunting the guild.
