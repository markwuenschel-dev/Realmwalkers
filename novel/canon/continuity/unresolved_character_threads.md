# Unresolved Character Threads — Dominion Realm

> **Purpose:** Central registry of open canon questions that affect character writing, plot decisions, or worldbuilding consistency. Resolve here before writing scenes that depend on them. Mark resolved items rather than deleting them — the resolution record matters.

> **Priority levels:**
> - 🔴 **Blocking** — cannot write dependent scenes until resolved
> - 🟡 **Important** — affects multiple scenes or characters; resolve soon
> - 🟢 **Open** — can write around it for now; resolve before final draft
...
## World / System Threads Affecting Characters
...
| # | Original Thread | Resolution | Date |
|---|---|---|---|
| — | — | — | — |
...
| W-03 | 🟡 | Xyloryn origin — immune response or other? | NOT confirmed as immune response. Still open. Do not write as confirmed in any scene. |
| CAL-01 | ✅ RESOLVED | Nine day names of the Realm week | **The Forgotten Nine** — Vael, Kora, Teren, Ashur, Neth, Rovan, Syth, Maelor, Ilyr. See `realm_calendar.md`. |
| CAL-02 | 🟢 | What month does Marcus arrive in the Realm? | Affects timeline anchoring. Unresolved. |
| CAL-03 | 🟢 | Does Eclipsia occur during Book 1? | Rare solar eclipse day. Potential convergence significance. Unresolved. |

---

## Act 3 — New Threads from False Rescue Design
