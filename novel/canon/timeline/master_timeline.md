...
| **Marcus nearly walks into Serra** — both at zero, the Earth Thing present | Day ~7 |
| Caravan — Dara, Cael, Vaeli (the elven child); toll-gang stops them | Day ~8 |
| **First live use of the Neurochromatic Eyes interface** (perception) — partial, incomplete notification; social puncture; gang retreats having "gotten what they needed" | Day ~8 |
...
Compressed travel funneling to Eriadne: rumors of the thread city; the standalone playful-chaos defusion; the Eyes' emotional-leak social cost; a first Xyloryn diagnostic hint; the felt ley pull. Marcus reaches Eriadne's outskirts ~Day 45.
...
| **Mara** | Lands in a stratified **court nation-state**; taken in for her beauty by a decent patron; a predatory courtier targets her; she goes un-salient (the ball), then exposes him before the full court (room-scale Specular Salience). Leaves the court for the **Walking Grove** (a moving civilization on a sick ancient behemoth); a salience-suppression threat there is the perfect Specular Salience foil — she makes the community perceive the danger at once; the behemoth's wound/migration routes her toward Eriadne. Does not meet Serra before Eriadne. |
