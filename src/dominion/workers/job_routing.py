...
def draft_job_for_beat(
    *, beat: Beat, chapter: Chapter, run: Run | None, target_scene_id: uuid.UUID | None = None
) -> Job:
...
async def revision_job_for_scene(
    session: AsyncSession, *, scene: Scene, chapter: Chapter, run: Run | None, target_pass: str | None
) -> Job:
