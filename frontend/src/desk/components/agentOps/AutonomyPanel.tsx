...
// the sweeper drives stalled runs forward but never auto-approves above the ceiling (and never
// human_required). Everything persists as KV settings and is read live on the next tick.
const CEILINGS = [
  "span_only",
  "scene_local",
  "scene_structural",
  ...
  return (
    ...
    >
      ...
      <p style={css("margin:0 0 14px;color:var(--dim);font-size:13px;line-height:1.5")}>
        ...
        auto-approving repairs up to the authority ceiling (never human_required) and auto-verifying
        once revisions land. Everything it does appears in the Activity tab and stays rollbackable.
      </p>
