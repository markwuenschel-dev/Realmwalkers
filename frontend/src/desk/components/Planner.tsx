        ...
        <>
          ...
          <div style={css("display:flex;gap:14px;align-items:flex-end;flex-wrap:wrap")}>
            ...
            <label><span style={fieldLabel}>Max scenes</span>
              <input type="number" min={1} value={maxBeats} placeholder="24" onChange={(e) => setMaxBeats(e.target.value)} style={numInput(80)} /></label>
          ...
          {currentChapter && (
            <label style={css("display:block;margin-top:10px")}>
              <span style={fieldLabel}>Chapter title <span style={css("text-transform:none;letter-spacing:0;color:var(--dim)")}>— generated on propose; edit freely</span></span>
              <input
                ...
                onBlur={(e) => {
                  ...
                  if (v !== (currentChapter.title ?? "")) data.updateChapter(currentChapter.id, { title: v || null });
                }}
                style={input}
              />
            </label>
