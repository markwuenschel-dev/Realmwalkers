...
export const DESK_ROUTES: readonly DeskRoute[] = [
  { id: "inbox", label: "Inbox", paletteLabel: "Go to Inbox", href: "/inbox", key: "i", shortcut: "G I", icon: "◧", nav: true },
  { id: "scene", label: "Scene", paletteLabel: "Open Scene · review queue", href: "/scene", key: "s", shortcut: "G S", icon: "❖", nav: true },
  { id: "chapters", label: "Chapters", paletteLabel: "Open Chapter board & progress", href: "/chapters", key: "c", shortcut: "G C", icon: "▦", nav: true },
  { id: "packets", label: "Packets", paletteLabel: "Open Knowledge packets", href: "/packets", key: "p", shortcut: "G P", icon: "▧", nav: true },
  { id: "diff", label: "Versions", paletteLabel: "Compare versions", href: "/diff", key: "v", shortcut: "G V", icon: "⇄", nav: true },
  { id: "manuscript", label: "Manuscript", paletteLabel: "Open Manuscript", href: "/manuscript", key: "m", shortcut: "G M", icon: "❡", nav: true },
  { id: "ledger", label: "Ledger", paletteLabel: "Open World ledger", href: "/ledger", key: "l", shortcut: "G L", icon: "◍", nav: true },
  { id: "docs", label: "Canon", paletteLabel: "Open Canon docs", href: "/docs", key: "d", shortcut: "G D", icon: "❡", nav: true },
  { id: "settings", label: "Models", paletteLabel: "Open Model settings", href: "/settings", icon: "⚙", nav: true },
] as const;
