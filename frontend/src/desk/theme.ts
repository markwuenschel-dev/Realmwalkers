...
export const themes: Record<ThemeId, ThemeTokens> = {
  grimoire: {
    ...
    bg2b: "#1a1622",
    bg3: "#211c2b",
    barbg: "rgba(13,11,18,.82)",
    ink: "#ece3d0",
    dim: "#94897a",
    accent: "#c9a253",
    accentSoft: "rgba(201,162,83,.14)",
    accentLine: "rgba(201,162,83,.4)",
    onAccent: "#1a1306",
    boxbg: "#120f18",
    line: "#2a2433",
    hairline: "rgba(236,227,208,.07)",
    good: "#6fcf97",
    warn: "#e0b15a",
    bad: "#e1719b",
    info: "#7aa2f7",
  ...
  manuscript: {
    ...
    bg2b: "#f6f2e9",
    bg3: "#efe9dc",
    barbg: "rgba(248,245,238,.82)",
    ink: "#241f18",
    dim: "#8a8170",
    accent: "#8a2f2f",
    accentSoft: "rgba(138,47,47,.08)",
    accentLine: "rgba(138,47,47,.28)",
    onAccent: "#fff",
    boxbg: "#f6f1e7",
    line: "#e2dac9",
    hairline: "rgba(36,31,24,.07)",
    good: "#2f7d57",
    warn: "#9a6a1f",
    bad: "#a23a52",
    info: "#355f9e",
  ...
  console: {
    ...
    bg2b: "#141922",
    bg3: "#19202b",
    barbg: "rgba(10,13,18,.82)",
    ink: "#d4dee8",
    dim: "#76879a",
    accent: "#4fd6e0",
    accentSoft: "rgba(79,214,224,.12)",
    accentLine: "rgba(79,214,224,.32)",
    onAccent: "#04181a",
    boxbg: "#0c1117",
    line: "#1e2731",
    hairline: "rgba(212,222,232,.06)",
    good: "#57d98a",
    warn: "#e3b341",
    bad: "#f0738f",
    info: "#6aa8ff",
